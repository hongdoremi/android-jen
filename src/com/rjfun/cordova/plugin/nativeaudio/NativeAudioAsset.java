...
public class NativeAudioAsset
{
	...
	public NativeAudioAsset(AssetFileDescriptor afd, int numVoices, float volume, String fullPath) throws IOException
	{
		...
		{
			NativeAudioAssetComplex voice = new NativeAudioAssetComplex(afd, volume, fullPath);
			voices.add( voice );
		}
	}
