 ...
 * @constructor
 */
function CGameLN(my, parentGroup, oData) {
    var _bUpdate = false;
    var _bAutoSpin;
    ...
    var firstArrayOfLoadAnimation = [];

  var interval4AllAnimation;
    ...
    this._init = function () {
      ...
      my.currentGameSlot.shouldDestroyLoading = true;
        ...
        //_oFooter.setPosition(settings.CANVAS_WIDTH/2 - 575, settings.CANVAS_HEIGHT - 100);
        _oFooter.setPosition(settings.CANVAS_WIDTH/2, settings.CANVAS_HEIGHT - 100);
        //_oFooter.setY(settings.CANVAS_HEIGHT - 100);
        ...
        _oWinAnim = new CWinAnimLN(my, _oAttachWinAnim);
        my.scaleCenterGroup(_oAttachWinAnim,1,null);
        ...
        _oInterface = new CInterfaceLN(my, _oContainer,arrayOfAnimation);
        _oNezhaAvatar = new CAvatarNezha(my, _oContainer);
        arrayOfAnimation.push(_oNezhaAvatar);
        _oNezhaAvatar.playIdle();
        //
        //_oSettingsPanel = new CSettingsPanel();
        //
        //_oBonusJackPot = new CBonusJackPot(s_oAttachSection);
        _oBonusPalace = new CBonusPalaceLN(my, parentGroup, arrayOfAnimation);

        _oBonusBattle = new CBonusBattleLN(my, parentGroup);
        /////////////////////
        _oWinPanel = new CWinPanelLN(my, parentGroup, arrayOfAnimation);
        //Init state manager
        Manager4State.init();
...
//                });
//        this.createSeaAnimation();
//        _oInterface.showFreeSpinIndicator();
//        if(my.currentGameSlot.finishAPI){
        ...
        //    {
        //        LobbyC.GameSlot.getCurrentGame().s_oGame.getFooter().reloadBet(90000);
        //    }
      ...
      this.runInterval4AllAnimation();

      //my.currentGameSlot.startGame();
     ...
     * Deprecated
     */
    my.firstLoadAnimationMain = function(){
return;
      var scaleRatio = 0.3;
      ...
      sprite = my.add.sprite(0,0,'static_symbol', 'frame_win', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,10,'static_symbol', 'symbol_0', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,15,'static_symbol', 'symbol_1', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,20,'static_symbol', 'symbol_2', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,25,'static_symbol', 'symbol_3', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,30,'static_symbol', 'symbol_4', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,35,'static_symbol', 'symbol_5', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,40,'static_symbol', 'symbol_6', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,45,'static_symbol', 'symbol_7', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,50,'static_symbol', 'symbol_8', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,55,'static_symbol', 'symbol_9', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'static_symbol', 'symbol_10', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);

      sprite = new SpriteAnimation(my,
        group,
        {x:100,y:100},
      ...
      //sprite =  my.add.sprite(10,10,'dragon_body1', null, group);
      //sprite.scale.setTo(scaleRatio);
      //firstArrayOfLoadAnimation.push(sprite);
      //sprite =  my.add.sprite(20,20,'dragon_body2', null, group);
      //sprite.scale.setTo(scaleRatio);
      //firstArrayOfLoadAnimation.push(sprite);
      //sprite =  my.add.sprite(30,30,'dragon_head', null, group);
      //sprite.scale.setTo(scaleRatio);
      //firstArrayOfLoadAnimation.push(sprite);
      ...
      var _iCurSymbol = 11;
      while (_iCurSymbol--) {
          var i = my.slotSettings.s_iSymbolAnims[_iCurSymbol]; while (i--) {
              sprite = my.add.sprite(x, y, "symbol" + _iCurSymbol + "_" + (i + 1));
              sprite.scale.setTo(scaleRatio);
              firstArrayOfLoadAnimation.push(sprite);
              x += 1;
          }
      ...
      //for(_iCurSymbol=0;_iCurSymbol<11;_iCurSymbol++) {
      //}

      sprite = my.add.sprite(0,60,'line_1_2_3', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_4', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_5', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_6_15', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_8_16', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_7_14', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_9_17', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_10_13', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
      sprite = my.add.sprite(0,60,'line_11_12', group);
      sprite.scale.setTo(scaleRatio);
      firstArrayOfLoadAnimation.push(sprite);
     ...
     * Deprecated
     */
    my.stopPreloadAnimation = function(){
      //for(var i  = 0; i < arrayOfAnimation.length; i++) {
      //  if(arrayOfAnimation[i].need2LoadFirst == true) {
      //    arrayOfAnimation[i].stop(
      //    );
      //  }
      //}

        var i = firstArrayOfLoadAnimation.length; while (i--) {
            if(Lobby.Utils.objectNotNull(firstArrayOfLoadAnimation[i].stop)) {
                firstArrayOfLoadAnimation[i].stop(
                );
            }

            if(Lobby.Utils.objectNotNull(firstArrayOfLoadAnimation[i].destroy)){
                firstArrayOfLoadAnimation[i].destroy(
                );
            }
        }
      //for(var i  = 0; i < firstArrayOfLoadAnimation.length; i++) {
      //
      //}
      firstArrayOfLoadAnimation = [];
    ...
    this.initLines = function(){
        ...
        [
            'line_1_2_3','line_1_2_3','line_1_2_3','line_4','line_5','line_6_15',
            'line_7_14','line_8_16','line_9_17','line_10_13','line_11_12','line_11_12',
            'line_10_13','line_7_14','line_6_15','line_8_16','line_9_17','line_18',
            'line_19','line_20','line_21','line_22','line_23','line_24',
            'line_25','line_26','line_27','line_28','line_29','line_30'
        ]);
        _isInitLines = true;
    };
    /**
    ...
    /**
     * Get Bonus Palace Object
     * @returns {*} Bonus Palace Object
     */
    this.getBonus1 = function(){
        return _oBonusPalace;
    };
    /**
     * Get Bonus Battle Object
     * @returns {*} Bonus Battle Object
     */
    this.getBonus2 = function(){
        return _oBonusBattle;
    };
    /**
     * Create Sea Animation background
     */
    this.createSeaAnimation = function(){
      ...
      //}
        var group = my.add.group();
        _oContainer.add(group);

        // = new SimpleSpriteSheetAnimation(
        //    my,
        //    group,
        //    {x:0,y:0},
        //    'sea_',
        ...
        //seaAnim.scale({x:2*100/70,y:2*100/70});
        //seaAnim.scale({x:1.1,y:1.1});
        group.x = settings.CANVAS_WIDTH/2;
        group.y = (settings.CANVAS_HEIGHT/2 + 240);//*ManagerForScale.getScale();

        //my.scaleCenterGroup(group,2*100/70);
        group.scale.setTo(2*100/70);

        //group.y *= my.scaleGameSlot;
        //seaAnim.play();
        seaAnim.playWithoutTimer();
        arrayOfAnimation.push(seaAnim);
    };
    ...
    this._initReels = function () {
        ...
        //oReels.position = {x:0,y: (Lobby.Utils.is3x4Device()?5 : - 0.5)};
        oReels.position = {x:0,y:  - 0.5};
        var bg = my.add.sprite(Lobby.Utils.floatToIntOptimize(settings.CANVAS_WIDTH/2) - 5, Lobby.Utils.floatToIntOptimize(settings.CANVAS_HEIGHT/2) - 25, 'reels', null, _oContainer);
        bg.anchor.setTo(0.5);
        ...
        myMask.drawRect(
            ...
            //settings.REEL_OFFSET_Y + ((settings.SYMBOL_HEIGHT + settings.SPACE_HEIGHT_BETWEEN_SYMBOLS) * (settings.NUM_ROWS - (Lobby.Utils.is3x4Device()?1.025 : 1.035)))
            settings.REEL_OFFSET_Y + ((settings.SYMBOL_HEIGHT + settings.SPACE_HEIGHT_BETWEEN_SYMBOLS) * (settings.NUM_ROWS -  1.035))
        );
        myMask.endFill();
        ...
        for (var i = 0; i < settings.NUM_REELS; i++) {
            ...
            _aMovingColumns[i] = new CReelColumnLN(my, i, iXPos, iYPos, iCurDelay, aSymbols, _oAttachSymbols,
                _oAttachWinFrames);
            _aMovingColumns[i + settings.NUM_REELS] = new CReelColumnLN(my, i + settings.NUM_REELS, iXPos,
        ...
        my.scaleCenterGroup(oReels,1,null);
    };
    /**
     * Generate Losing Bet
     */
    ...
    this.checkLastState = function () {
        ...
        if (my.currentGameSlot.s_oBonusToRestore !== null) {
            ...
            switch (my.currentGameSlot.s_oBonusToRestore.bonus_id) {
                case 1:
                {
                    //_oBonusBattle.show(my.currentGameSlot.s_oBonusToRestore.doubleUpCurrentWin);
                    break;
                }
    ...
    this.changeSpin2FreeSpin = function (totalFS,
        ...
        //_oFooter.setPosition(settings.CANVAS_WIDTH/2 - 575 + (ManagerForScale.is3x4resolution()?50:0), settings.CANVAS_HEIGHT - 100);
        _oNezhaAvatar.playFreespin();
        _oInterface.showFreeSpinIndicator();
     ...
     */
    this.stopNextReel = function (scatterStopMusic) {
        if ( LobbyConfig.isDebug
            ) {
            if ( LobbyConfig.isDebug
                ) {
    ...
    this._endReelAnimation = function () {
        ...
        my.afterSpinHandle(function() {
            ...
            if (LobbyUserData.dataTutorial.isPlayingTutorial == true
                ...
                LobbyC.MainMenu.showPopupMegaWin(my.currentGameSlot.s_iCurWin,
                    function(){
                      my.time.events.add(1000,
                        function () {
                            LobbyC.MainMenu.gotoStep(LobbyConstant.Constant4Tutorial.StepClickHomeButton);
                        }, this);
                    });
            }
            ...
            if (_aWinningLine.length > 0) {
                ...
                if (_iTotFreeSpin <= 0) {
                    _oNezhaAvatar.playRandomWinAnim();
                }
        ...
        if (_iCurWinShown === _aWinningLine.length) {
            ...
            if (_iTotFreeSpin > 0) {
                ...
                if(_bShowTotalWinOnFreeSpin) {
                    //CHECK LATER
                  my.time.events.add(8000,
                    function () {
                      Manager4Sound.playBackgroundMusic();
                        my.currentGameSlot.s_oStage.getChildAt(2).visible = true;}, this);
    ...
    this._launchBonus = function () {
        ...
        switch (_iBonusActive) {
            case settings.BONUS_TYPE_PALACE:
            {
                ...
                _oInterface.showStartBonusBut(3);
            ...
            case settings.BONUS_TYPE_BATTLE:
            {
                Manager4State.setCurrentState (my.currentGameSlot.GameConstant.State.Bonus);
                _iBonusActive = -1;
                _oInterface.showStartBonusBut(4);
                _oInterface.hideSpinBtn();
                //my.currentGameSlot.manager4Network.callBonus(_iStepBonus,0);
                break;
            }
    ...
    this._prepareForBonus = function () {
        ...
        switch (_iBonusActive) {
            ...
            case settings.BONUS_TYPE_PALACE:
            {
                ...
                iSymbol = settings.PALACE_SYMBOL;
                break;
            }
            case settings.BONUS_TYPE_BATTLE:
            {
                //iSymbol = BONUS_LOTION_SYMBOL;
                iSymbol = settings.BATTLE_SYMBOL;
                break;
            }
        }
    ...
    this.forceToCloseBonus = function(){
        switch(Manager4State.getCurrentState()){
            case my.currentGameSlot.GameConstant.State.Bonus:
                _oBonusBattle._exitFromBonus();
                break;
            case my.currentGameSlot.GameConstant.State.DoubleUp:
                _oBonusPalace.exitFromBonus();
                break;
    ...
    this.generateLosingWheel = function () {
        ...
        var i = settings.NUM_ROWS; while (i--) {
            var j = settings.NUM_REELS; while (j--) {
                _aFinalSymbolCombo[i][j] = _aCurWheel[i][j] = aTmp[iCont];
                iCont++;
            }
        }
        //for (var i = 0; i < ; i++) {
    ...
    /**
     * Set auto spin state
     * @param isAutoSpin: boolean - true if it's auto spin
     */
     ...
     * @returns {*} boolean - true if it's auto spin
     */
...
//dat fix loi ko du tien khi click vo play bonus ko duoc
        ...
        _iTotFreeSpin > 0 && _bShowTotalWinOnFreeSpin == true) {
          ...
          my.time.events.add(8000,
            function () {
              Manager4Sound.playBackgroundMusic();}, this);
            _bShowTotalWinOnFreeSpin = false;
            return;
        }
        //Manager4Sound.playBackgroundMusic();
    ...
    this.onSpin = function () {
        ...
        if(LobbyUserData.dataTutorial.isPlayingTutorial == false) {
            ...
            if(LobbyUserData.dataTutorial.isClickSpin == false){
                _oInterface.onSpinStarted();
                my.beforeEnterNormalSpinHandle();
                _oInterface.hideDragonWild();
                ...
                _oInterface.hideBtnDoubleUp();
                this.localSpin();
                LobbyUserData.dataTutorial.isClickSpin = true;
                var xmlString = LobbyUserData.dataTutorial.infoSpin;
                var parser = new DOMParser();
                var xmlDoc = parser.parseFromString(xmlString, "text/xml");
                my.currentGameSlot.onSpinReceived(xmlDoc);
                Manager4Sound.playBackgroundMusic();
            }
        }
    };
    ...
    this.onSpinReceived = function (aWheels, aWinPosition, aTableWin, iBonus, aBonusPos) {
        ...
        if(LobbyConfig.isTestAlgorithmMode) {
            if(_iBonusActive > 0){
                ...
                my.reloadProfileForTestSpin(true,null,null,_iBonusActive,_iStepBonus);
            }else{
    ...
    this.onBonusFreeSpinStepReceived =
        function (
            ...
            var index = iRemainingFreeSpin%4;
            colAnim = (index == 0?1:4 - index);

            _oInterface.showDragonWild(colAnim);
    ...
    this.onDoubleUpStep1Received = function (iFinish, iResult, iTotWin) {
        ...
        //_oBonusBattle.showResult(iFinish, iResult, iTotWin);
        //
        //_iStepBonus++;
    };
    /**
        ...
        if(my.currentGameSlot.s_oBonusToRestore) {
            switch (my.currentGameSlot.s_oBonusToRestore.bonus_id) {
                case 1:
                    break;
                case settings.BONUS_TYPE_PALACE:
                    return my.getRandomParam(_oBonusPalace.getArrayOfSelected());
                    break;
                case settings.BONUS_TYPE_FREESPIN:
                    break;
                case settings.BONUS_TYPE_BATTLE:
                    return my.getRandomParam(_oBonusBattle.getArrayOfSelected());
                    break;
            }
            return 0;
        }
    ...
    this.resetTestBonusResult = function(){
        if(!LobbyConfig.isTestAlgorithmMode &&
            ...
            !my.managerForAutoGameSlot.autoPlayBonus)
            ||
            Lobby.Utils.objectIsNull(my.managerForAutoGameSlot))){
            return;
        }
        _oBonusPalace.resetBonusTest();
        _oBonusBattle.resetBonusTest();
    };
    /**
     * FUNCTION CALLED WHEN BONUS PALACE STEP 0 IS RECEIVED
     */
    this.onBonusPalaceStep0Received = function () {
        if ( LobbyConfig.isDebug
            ) {
        ...
        if(LobbyConfig.isTestAlgorithmMode) {
            ...
            my.reloadProfileForTestSpin(true,
                my.getRandomParam(_oBonusPalace.getArrayOfSelected()),
                true,
                settings.BONUS_TYPE_PALACE,
                this.getStepBonus()-1,
                null,
                "Palace"
            );
     ...
     * @param aWheels: array wheels info
     */
    this.onBonusPalaceStep1Received = function (iFinish, aWheels) {
        if ( LobbyConfig.isDebug
            ) {
        ...
        if(LobbyConfig.isTestAlgorithmMode) {
            var resultWin = _oBonusPalace.showResult(iFinish, aWheels, aWheels.length - 1);
            my.reloadProfileForTestSpin(!iFinish,
                my.getRandomParam(_oBonusPalace.getArrayOfSelected()),
                true,
                settings.BONUS_TYPE_PALACE,
                this.getStepBonus()-1,
            ...
            _oBonusPalace.showResult(iFinish, aWheels, aWheels.length - 1);
        }
     ...
     */
    this.onBonusBattleStep0Received = function () {
        if (LobbyConfig.isDebug
        ) {
            console.log("CGame onBonusBattleStep0Received");
        }
        _oInterface.refreshBalance();
        if (LobbyConfig.isTestAlgorithmMode) {
            _iStepBonus++;
            my.reloadProfileForTestSpin(true,
                my.getRandomParam(_oBonusBattle.getArrayOfSelected()),
                true,
                settings.BONUS_TYPE_BATTLE,
                this.getStepBonus()-1,
                null,
                "Battle"
            );
     ...
     * @param aWheels: array wheels info
     */
    this.onBonusBattleStep1Received = function (iFinish, aWheels) {
        if ( LobbyConfig.isDebug
            ) {
        ...
        _iStepBonus++;
        if(LobbyConfig.isTestAlgorithmMode) {
            var resultWin = _oBonusBattle.showResult(iFinish, aWheels, aWheels.length - 1, true);
            my.reloadProfileForTestSpin(!iFinish,
                my.getRandomParam(_oBonusBattle.getArrayOfSelected()),
                true,
                settings.BONUS_TYPE_BATTLE,
            ...
            _oBonusBattle.showResult(iFinish, aWheels, aWheels.length - 1, true);
        }
    ...
    this.onExit = function () {
        ...
        _oWinAnim = null;
        _oWinPanel = null;
        _oBonusBattle.destroy();
        _oBonusBattle = null;
        _oBonusPalace.destroy();
        _oBonusPalace = null;
        _oInterface.unload();
        _oInterface = null;
        _oLines = null;
        _oNezhaAvatar.destroy();
        _oNezhaAvatar = null;
        if(seaAnim){
            seaAnim.stop();
            seaAnim.destroy();
        ...
        var i = arrayOfAnimation.length; while (i--) {
            //arrayOfAnimation[i].stop();
            arrayOfAnimation[i].destroy();
            arrayOfAnimation[i] = null;
        }
        arrayOfAnimation = null;
        i = _aMovingColumns.length; while (i--) {
            _aMovingColumns[i].unload();
            _aMovingColumns[i] = null;
        }
    ...
    /**
     * Run initialize for all animation
     */
    this.runInterval4AllAnimation = function(){
      //if(Lobby.Utils.objectNotNull(interval4AllAnimation)){
      //  return;
      //}
        var j = 20; while (j--) {
            var i = arrayOfAnimation.length; while (i--) {arrayOfAnimation[i].update();}
        }
        //for(var j = 0; j < 20; j++) {
        ////for (var i = 0; i < arrayOfAnimation.length; i++) {
        ////
    ...
    this.update = function () {
        ...
        var i = firstArrayOfLoadAnimation.length; while (i--) {
            if(Lobby.Utils.objectNotNull(firstArrayOfLoadAnimation[i].update)) {
                firstArrayOfLoadAnimation[i].update(
                );
            }}
      //for(var i  = 0; i < firstArrayOfLoadAnimation.length; i++) {
      //}
        ...
        var i = arrayOfAnimation.length; while (i--) {
            arrayOfAnimation[i].update(
                //function(){
                //
                //if(my.currentGameSlot.shouldDestroyLoading  == true){
                //  my.currentGameSlot.shouldDestroyLoading = false;
                //  my.currentGameSlot.destroyLoading();
                //
                //}
                //}
      ...
      //for(var i  = 0; i < arrayOfAnimation.length; i++) {
      //}
        //if (_oBonusBattle.isShowed) {
        //    _oBonusBattle.update();
        //}
