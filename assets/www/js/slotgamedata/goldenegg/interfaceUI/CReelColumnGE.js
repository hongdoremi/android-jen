 ...
 * @constructor
 */
function CReelColumnGE(my, iIndex, iXPos, iYPos, iDelay, aSymbols, oAttachSymbols, oAttachWinFrames) {
    var that = new CReelColumnBase(my,
        ...
        function(_oAttachWinFrames){
            ...
            _oSymbolHighlight.scale.setTo(settings.SYMBOL_SCALE_NORMAL);

            var _oWinFrame = my.add.sprite(0,0, 'static_symbol', 'frame_win',_oAttachWinFrames);
            _oWinFrame.anchor.setTo(0);
...
//        _iCurState = settings.GEREEL_STATE_START;
...
//            //oSymbolData.scale.setTo(2);//reduce 50% resolution
//
//            oSymbolData.x = iX;
//            oSymbolData.y = iY;
//            oSymbolData.scale.setTo(settings.SYMBOL_SCALE_NORMAL);//reduce 0% resolution
...
//            _iCntFrames = 0;
//            _iMaxFrames = settings.MAX_FRAMES_REEL_EASE;
//            _iCurState = settings.GEREEL_STATE_STOP;
//
...
//
//            switch (_iCurState) {
//                case settings.GEREEL_STATE_START:
//                {
//                    this._updateStart();
//                    break;
//                }
//                case settings.GEREEL_STATE_MOVING:
//                {
//                    this._updateMoving();
//                    break;
//                }
//                case settings.GEREEL_STATE_STOP:
//                {
